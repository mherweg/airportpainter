 ...
 */
public class LongFormat extends LatLongFormat {

	/**
	 * 
	 */
	private static final long serialVersionUID = -490131286267664175L;
	...
	public StringBuffer format(
		...
		return super.formatAbsolute(number, toAppendTo, pos).append(number>0?"E":"W");
	}
